const TRANSLATIONS = {
  fr: {
    ...
    'ss9.label': 'Objectif de saison',
    'ss10.label': 'Lineups — Clips par carte & agent',
    'ss11.label': 'Infos — Agents, cartes & armes',
    'ss12.label': 'Sauvegardes de réglages',
    'ss13.label': 'Paramètres — Thèmes & confidentialité',
  ...
  en: {
    ...
    'ss9.label': 'Season goal',
    'ss10.label': 'Lineups — Clips by map & agent',
    'ss11.label': 'Info — Agents, maps & weapons',
    'ss12.label': 'Settings backups',
    'ss13.label': 'Settings — Themes & privacy',
    'ss1.ph': 'Daily shop',
